...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.createRobotButton.setGeometry(QtCore.QRect(610, 10, 171, 31))
        ...
        self.createObstacleButton.setGeometry(QtCore.QRect(610, 50, 171, 31))
